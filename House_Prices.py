...
kn_pipe = Pipeline([('clf', KNeighborsRegressor())])
...
grids = [gs_rf, gs_mlp, gs_dt, gs_kn, gs_svm]
#
grid_dict = {0: 'Random Forest', 1: 'Multi Layer Perceptor', 2: 'Decision Tree', 3: 'KNeighbors', 4: 'Support Vectors'}
#
